...
description: Find nearby Korean gas stations and cheapest fuel prices (Opinet aroundAll). Optional OpenClaw skill that runs the nearby-gas-prices CLI and summarizes results.
---
